...
const RegistrationForm = () => {
  ...
  return (
    ...
    <div className='partner1'>
      <h3 className='fw-semibold text-secondary'>Partners & Donors</h3>
      ...
      <Row>
        <Col md={8} lg={6} className="p-4 border rounded shadow-sm bg-light">
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formSSN" className="mt-2">
              ...
              <Form.Control
                ...
                maxLength="11" // Limit input to 11 characters (9 digits + 2 dashes)
                required
              />
            </Form.Group>
            ...
            <p className='fst-italic mt-3'>Please confirm and check your details before submitting to avoid <span style={{color: "#FF0000"}}>error(s)</span> during payment</p>
